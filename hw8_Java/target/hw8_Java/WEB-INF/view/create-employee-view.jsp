...
<body>
    ...
    <div class="container">
        <form:form action="addNewEmployee" modelAttribute="createEmployee" cssClass="px-5 py-5">
            <p class="h3 text-center text-success my-3">Добавление нового работника:</p>
            <div class="mb-3">
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-success my-3">Добавить работника</button>
            </div>
        </form:form>
    </div>
</body>
